  ...
  training_programs: [
    {
      ...
      modules: [
        { id: 1, title_ar: 'مقدمة في صندوق الحماية الاجتماعية', title_en: 'Introduction to the Social Protection Fund', duration_ar: '2 ساعة', duration_en: '2 hours', status: 'done' },
        { id: 2, title_ar: 'أساسيات قانون الحماية الاجتماعية', title_en: 'Fundamentals of the Social Protection Law', duration_ar: '4 ساعات', duration_en: '4 hours', status: 'done' },
        { id: 3, title_ar: 'إجراءات تقديم الخدمات', title_en: 'Service Delivery Procedures', duration_ar: '3 ساعات', duration_en: '3 hours', status: 'active' },
        { id: 4, title_ar: 'مهارات التواصل مع المتعاملين', title_en: 'Communication Skills with Clients', duration_ar: '3 ساعات', duration_en: '3 hours', status: 'locked' },
        { id: 5, title_ar: 'اختبار الاستعداد النهائي', title_en: 'Final Readiness Assessment', duration_ar: '1 ساعة', duration_en: '1 hour', status: 'locked' }
      ]
    },
    {
      id: 2,
      ...
      modules: [
        { id: 1, title_ar: 'مراجعة قانون الحماية الاجتماعية الجديد', title_en: 'Review of New Social Protection Law', duration_ar: '3 ساعات', duration_en: '3 hours', status: 'done' },
        { id: 2, title_ar: 'الحالات المعقدة والاستثنائية', title_en: 'Complex & Exceptional Cases', duration_ar: '4 ساعات', duration_en: '4 hours', status: 'done' },
        { id: 3, title_ar: 'تحليل البيانات وإعداد التقارير', title_en: 'Data Analysis & Reporting', duration_ar: '3 ساعات', duration_en: '3 hours', status: 'done' },
        { id: 4, title_ar: 'إدارة شكاوى المتعاملين', title_en: 'Client Complaint Management', duration_ar: '2 ساعات', duration_en: '2 hours', status: 'active' },
        { id: 5, title_ar: 'أخلاقيات العمل والسرية', title_en: 'Work Ethics & Confidentiality', duration_ar: '2 ساعات', duration_en: '2 hours', status: 'locked' },
        { id: 6, title_ar: 'اختبار إتقان المهارات', title_en: 'Skills Mastery Assessment', duration_ar: '1 ساعة', duration_en: '1 hour', status: 'locked' }
      ]
    },
    {
      id: 3,
      ...
      modules: [
        { id: 1, title_ar: 'قيادة فرق الخدمة', title_en: 'Leading Service Teams', duration_ar: '3 ساعات', duration_en: '3 hours', status: 'locked' },
        { id: 2, title_ar: 'مؤشرات الأداء وقياسه', title_en: 'KPIs & Performance Measurement', duration_ar: '3 ساعات', duration_en: '3 hours', status: 'locked' },
        { id: 3, title_ar: 'تطوير الكفاءات الوظيفية', title_en: 'Staff Competency Development', duration_ar: '2 ساعات', duration_en: '2 hours', status: 'locked' },
        { id: 4, title_ar: 'اختبار القيادة والإدارة', title_en: 'Leadership & Management Assessment', duration_ar: '1 ساعة', duration_en: '1 hour', status: 'locked' }
      ]
    }
  ],
